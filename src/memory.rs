use x86_64::structures::paging::{FrameAllocator, Mapper, Page, PageTable, PhysFrame, Size4KiB};
...
pub fn create_example_mapping(
    ...
    map_to_results.expect("failed map").flush();
}

pub unsafe fn init(physical_mem_offset: VirtAddr) -> OffsetPageTable<'static> {
    let level_4_table_frame = active_level_4_table(physical_mem_offset);
    OffsetPageTable::new(level_4_table_frame, physical_mem_offset)
}
